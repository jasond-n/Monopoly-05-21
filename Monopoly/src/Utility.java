...
public class Utility extends Property {
	...
	public void doActionAfterPlayerLandingHere(Player player, int roll, Board board)
	{
		...
		else if((board.getProperties().get(11).getOwner() != player) || (board.getProperties().get(27).getOwner() != player))
		{
			if((board.getProperties().get(11).getOwner() == board.getProperties().get(27).getOwner()) &&  board.getProperties().get(11).getOwner() != null) {
